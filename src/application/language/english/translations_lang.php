...
$lang['manage_appointment_record_hint'] = 'Manage all the appointment records of the available teachers and services.';
$lang['select_filter_item_hint'] = 'Select a teacher or a service and view the appointments on the calendar.';
...
$lang['manage_users_hint'] = 'Manage the backend team members (admins, teachers, secretaries).';
...
$lang['edit_working_plan_hint'] = 'Mark below the days and hours that your company will accept appointments. You will be able to adjust appointments in non working hours but the students will not be able to book appointments by themselves in non working periods. This working plan will be the default for every new teacher record but you will be able to change each teacher\'s plan separately by editing his record. After that you can add break periods.';
...
$lang['about_ea_info'] = 'Easy!Appointments is a highly customizable web application that allows your students to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar so you can use them with other services.';
